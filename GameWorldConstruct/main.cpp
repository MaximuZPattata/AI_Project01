...
//---------------------Game World Character Model Instances-------------------------------

sPlayerAttributes playerAttributes(glm::vec3(-20.f, 10.5f, 0.f), 0.f, "Spiderman", 2.5f);
cEnemyAttributes enemy01("Beholder01", glm::vec3(20.f, 10.f, 0.f), glm::vec3(-1.f, 0.f, 0.f), 15.0f);
cEnemyAttributes enemy02("Beholder02", glm::vec3(50.0, 10.0, 20.0), glm::vec3(-1.f, 0.f, 0.f), 15.0f);
cEnemyAttributes enemy03("Beholder03", glm::vec3(40.0, 10.0, -20.0), glm::vec3(-1.f, 0.f, 0.f), 15.0f);
cEnemyAttributes enemy04("Beholder04", glm::vec3(-30.0, 10.0, -75.0), glm::vec3(-1.f, 0.f, 0.f), 15.0f);
cEnemyAttributes enemy05("Beholder05", glm::vec3(0.0, 10.0, 50.0), glm::vec3(-1.f, 0.f, 0.f), 15.0f);
...
void UpdateCameraPosition()
{
    ...
    glm::vec3 camOffset = glm::vec3(0.f, 75.0f, 150.f);
    glm::vec3 cameraPos = previousCameraPosition = gameEngine.GetCurrentCameraPosition();
    glm::vec3 targetPos = playerAttributes.playerPosition + playerAttributes.playerVelocity * static_cast<float>(gameEngine.deltaTime);
    glm::vec3 frontDirection = glm::normalize(targetPos - cameraPos);

    cameraPos = targetPos + camOffset;

    glm::vec3 smoothedCameraPosition = previousCameraPosition + (cameraPos - previousCameraPosition) * smoothingFactor;

    gameEngine.MoveCameraTarget(frontDirection.x, frontDirection.y, frontDirection.z);
    gameEngine.MoveCameraPosition(smoothedCameraPosition.x, smoothedCameraPosition.y, smoothedCameraPosition.z);
}
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        enemy01.Seek(gameEngine, playerAttributes);
        enemy02.Flee(gameEngine, playerAttributes);
        enemy03.Pursue(gameEngine, playerAttributes);
        enemy04.Evade(gameEngine, playerAttributes);
        enemy05.Approach(gameEngine, playerAttributes);
